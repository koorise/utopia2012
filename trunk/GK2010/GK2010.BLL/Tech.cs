...
namespace GK2010.BLL
{
	...
	{
		#region  私有变量
		private readonly GK2010.DAL.Tech dal=new GK2010.DAL.Tech();
		#endregion
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(GK2010.Model.Tech model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GK2010.Model.Tech model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public GK2010.Model.Tech GetModel(int ID)
		{
			
			DataSet ds = dal.GetModel(ID);
			List<GK2010.Model.Tech> models = DataTableToList(ds.Tables[0]);
			if (models.Count > 0)
			{
				return models[0];
			}
		...
		/// 得到一个对象实体(关键字)
		/// </summary>
		public GK2010.Model.Tech GetModel(string Keywords)
		{
		...
		public static string GetTitle(int ID)
		{
			...
			GK2010.Model.Tech model = bll.GetModel(ID);
			if (model != null)
			{
				return model.Title;
			}
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public GK2010.Model.Tech GetModelByCache(int ID)
		{
			
			string CacheKey = "TechModel-" + ID;
			...
			return (GK2010.Model.Tech)objModel;
		}
		#endregion
		...
		/// 列表(不分页)
		/// </summary>
		public List<GK2010.Model.Tech> GetList(string Keywords, string Type)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GK2010.Model.Tech> GetList(int PageSize, int PageIndex, string Keywords,string Type, out int totalRows)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Tech> DataTableToList(DataTable dt)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Tech> DataTableToList(DataRow[] drs)
		{
			List<GK2010.Model.Tech> modelList = new List<GK2010.Model.Tech>();
			GK2010.Model.Tech model;
			foreach (DataRow dr in drs)
			{
				model = new GK2010.Model.Tech();
				if(dr["ID"].ToString()!="")
				{
