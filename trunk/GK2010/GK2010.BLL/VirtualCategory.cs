...
{
	/// <summary>
	/// 业务逻辑类VirtualCategory 的摘要说明。
	/// </summary>
	public class VirtualCategory
	{
		#region  私有变量
		private readonly GK2010.DAL.VirtualCategory dal=new GK2010.DAL.VirtualCategory();
		#endregion
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(GK2010.Model.VirtualCategory model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GK2010.Model.VirtualCategory model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public GK2010.Model.VirtualCategory GetModel(int ID)
		{
			
			DataSet ds = dal.GetModel(ID);
			List<GK2010.Model.VirtualCategory> models = DataTableToList(ds.Tables[0]);
			if (models.Count > 0)
			{
				return models[0];
			}
		...
		/// 得到一个对象实体(关键字)
		/// </summary>
		public GK2010.Model.VirtualCategory GetModel(string Keywords)
		{
		...
		public static string GetTitle(int ID)
		{
			...
			GK2010.Model.VirtualCategory model = bll.GetModel(ID);
			if (model != null)
			{
				return model.Title;
			}
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public GK2010.Model.VirtualCategory GetModelByCache(int ID)
		{
			
			string CacheKey = "VirtualCategoryModel-" + ID;
			...
			return (GK2010.Model.VirtualCategory)objModel;
		}
		#endregion
		...
		/// 列表(不分页)
		/// </summary>
		public List<GK2010.Model.VirtualCategory> GetList(string Keywords, string Type)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GK2010.Model.VirtualCategory> GetList(int PageSize, int PageIndex, string Keywords,string Type, out int totalRows)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.VirtualCategory> DataTableToList(DataTable dt)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.VirtualCategory> DataTableToList(DataRow[] drs)
		{
			List<GK2010.Model.VirtualCategory> modelList = new List<GK2010.Model.VirtualCategory>();
			GK2010.Model.VirtualCategory model;
			foreach (DataRow dr in drs)
			{
				model = new GK2010.Model.VirtualCategory();
				if(dr["ID"].ToString()!="")
				{
