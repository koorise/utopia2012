<%@ Page Title="" Language="C#" MasterPageFile="~/ZPageBase_Member.master" AutoEventWireup="true" CodeBehind="member_consignee_modify.aspx.cs" Inherits="GK2010.Web.Member.MemberConsignee.member_consignee_modify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Position" runat="server">首页 > 我的工控 > 常用收货人修改
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Main" runat="server">
    ...
    <div class="bd_bd">
        <table cellpadding="0" cellspacing="0" class="wp95 m_center table3">
              ...
              <tr>
                <td></td>
                <td class="style2"><asp:Button ID="btnPost" runat="server" Text="修改" 
