<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.MemberGroup.Manage" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">角色管理列表</span></h2>
<div id="divGrid" class="admin_table mb10" >
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>
			...
			<asp:BoundField DataField="ID" HeaderText="角色编号" ReadOnly="True" >
				<ItemStyle cssclass="td2" />
			</asp:BoundField>
			...
			<asp:TemplateField HeaderText="操作" >
				<ItemTemplate><asp:HyperLink ID="HyperLinkPermmsion" runat="server">[指定权限]</asp:HyperLink><asp:HyperLink ID="HyperLinkModify" runat="server">[修改]</asp:HyperLink><asp:HyperLink ID="HyperLinkDelete" runat="server">[删除]</asp:HyperLink></ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField>
		</Columns>
...
<div id="divPage" class="pages">
	<webdiyer:AspNetPager ID="Pages1"  runat="server"  ></webdiyer:AspNetPager>
</div>
