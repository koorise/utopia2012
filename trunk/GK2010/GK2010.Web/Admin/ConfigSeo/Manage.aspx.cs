...
namespace GK2010.Web.Admin.ConfigSeo
{
	...
	private void BindData()
	{
		...
		List<GK2010.Model.ConfigSeo> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	...
	protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		{
			GK2010.Model.ConfigSeo model = (GK2010.Model.ConfigSeo)e.Row.DataItem;
