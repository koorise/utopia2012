<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="GK2010.Web.Admin.Program.Modify" Title=""  ValidateRequest="false" EnableEventValidation="false"  %>
...
<div class="tac mb10"><asp:Button ID="btnAdd" runat="server" Text="保存" CssClass="btn_yellow_big" OnClick="btnAdd_Click" ></asp:Button>
