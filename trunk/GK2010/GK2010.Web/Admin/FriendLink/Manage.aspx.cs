...
namespace GK2010.Web.Admin.FriendLink
{
    public partial class Manage : System.Web.UI.Page
    {
	    ...
	    private void BindData()
	    {
		    ...
		    List<GK2010.Model.FriendLink> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	    ...
	    protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	    {
		    ...
		    {
			    GK2010.Model.FriendLink model = (GK2010.Model.FriendLink)e.Row.DataItem;
