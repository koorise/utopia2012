<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage_Yes.aspx.cs" Inherits="GK2010.Web.Admin.Qa.Manage_Yes" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">解答中心管理（已解答）</span></h2>
<div id="divGrid" class="admin_table mb10" >
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>			
			...
			<asp:TemplateField HeaderText="解答时间">
				<ItemTemplate>
				<%# GK2010.Utility.DatetimeHelper.Parse(Eval("CheckDate"), "yyyy-MM-dd HH:mm")%>
				</ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 	
