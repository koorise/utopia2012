...
namespace GK2010.Web.Admin.HelpCategory
{
	...
	private void BindData()
	{
		...
		List<GK2010.Model.HelpCategory> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	...
	protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		{
			GK2010.Model.HelpCategory model = (GK2010.Model.HelpCategory)e.Row.DataItem;
