<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="GK2010.Web.Admin.ProductPartsCache.Modify" Title=""  ValidateRequest="false"   %>
...
<table cellSpacing="0" cellPadding="0" width="100%" >
	...
	<tr>
		<td class="td1">产品快照编号：</td>
		<td class="td2">
			<asp:TextBox id="txtProductCatchID" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
	<tr>
		<td class="td1">RootID：</td>
		<td class="td2">
			<asp:TextBox id="txtRootID" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="td1">CategoryPath：</td>
		<td class="td2">
			<asp:TextBox id="txtCategoryPath" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="td1">DefaultFlag：</td>
		<td class="td2">
			<asp:TextBox id="txtDefaultFlag" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
	<tr>
		<td class="td1">AttachmentFlag：</td>
		<td class="td2">
			<asp:TextBox id="txtAttachmentFlag" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
	<tr>
		...
		<td class="td2">
			<asp:TextBox id="txtFlag" runat="server" cssclass="input input_wa" ></asp:TextBox>
		</td>
		<td class="td2"><div class="help_a"></div></td>
	</tr>
</table>
