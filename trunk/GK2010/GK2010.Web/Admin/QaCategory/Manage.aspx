<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.QaCategory.Manage" Title="" %>
...
<h2 class="h1"><span  class="mr10">解答中心类别</span></h2>
<div class="admin_table mb10">
<table id="ftable" cellspacing="0" cellpadding="0" width="100%">
    <tr class="tr2">
        <td>[顺序]栏目名称</td>       
        <td style="display:none">栏目拼音</td>	   
        <td>操作</td>
    </tr>    
    <asp:Repeater id="RepeaterList" Runat="server">
        <ItemTemplate>        
         <tr class="vt tr1" onmouseover="showAdd('addbt_','<%#Eval("ID") %>')" onmouseout="hiddenAdd('addbt_','<%#Eval("ID") %>')">
		    ...
		    <td class="td2" style="display:none"><input type="text" runat="server" id="txtTitleEn"   class="input input_wa mr5" value='<%#Eval("TitleEn") %>' /></td>	  
            <td class="td2">
