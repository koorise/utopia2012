<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage_ChannelFlag.aspx.cs" Inherits="GK2010.Web.Admin.Down.Manage_ChannelFlag" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">下载中心管理（频道页首页推荐）</span></h2>
	...
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>			
			...
			<asp:TemplateField HeaderText="类别">
				<ItemTemplate><%# GK2010.BLL.DownCategory.GetTitle( Eval("CategoryID"))%></ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 
			...
			<asp:TemplateField HeaderText="推荐">
				<ItemTemplate>
                   <%# GK2010.Utility.StringHelper.GetStrFlag(Eval("ChannelFlag"), "推荐")%>
				</ItemTemplate>
				<ItemStyle cssclass="td2"  />
			</asp:TemplateField> 		
			<asp:TemplateField HeaderText="排序">
				<ItemTemplate>
                    <asp:TextBox ID="txtSortID" runat="server" Text='<%# Eval("ChannelSortID") %>' CssClass="input"></asp:TextBox>
				</ItemTemplate>
				<ItemStyle cssclass="td2"  />
			</asp:TemplateField> 	
