...
namespace GK2010.Web.Admin.ConfigNavigator
{
    public partial class Manage : System.Web.UI.Page
    {
	    ...
	    private void BindData()
	    {
		    ...
		    List<GK2010.Model.ConfigNavigator> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	    ...
	    protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	    {
		    ...
		    {
			    GK2010.Model.ConfigNavigator model = (GK2010.Model.ConfigNavigator)e.Row.DataItem;
