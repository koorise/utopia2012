<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.ConfigNavigator.Manage" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">网站导航管理列表</span></h2>
<div id="divGrid" class="admin_table mb10" >
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>
			...
			<asp:TemplateField HeaderText="拼音">
				<ItemTemplate><%# Eval("TitleEn") %></ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 	
			...
			<asp:TemplateField HeaderText="是否显示">
				<ItemTemplate><%# GK2010.Utility.StringHelper.GetStrFlag( Eval("IndexFlag"),"是","否") %></ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 	
