...
namespace GK2010.Web.Admin.ProductCache
{
	...
	private void BindData()
	{
		...
		List<GK2010.Model.ProductCache> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	...
	protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		{
			GK2010.Model.ProductCache model = (GK2010.Model.ProductCache)e.Row.DataItem;
