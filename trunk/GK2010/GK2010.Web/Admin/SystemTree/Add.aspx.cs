...
namespace GK2010.Web.Admin.SystemTree
{
    public partial class Add : System.Web.UI.Page
    {
	    protected void Page_Load(object sender, EventArgs e)
        {
            BLL.SystemTree.CheckPermission("SystemTree");
			if (!IsPostBack)
			{
                txtParentID.Text = BLL.SystemTree.GetTitle(ConfigParam.ParentID);
			}
		}
       	...
       	protected void btnAdd_Click(object sender, EventArgs e)
		{
			...
			GK2010.Model.SystemTree model=new GK2010.Model.SystemTree();
