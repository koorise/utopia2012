<%@ Page Title="" Language="C#" MasterPageFile="~/ZPageBase_MainChannel.master" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="GK2010.Web.Program.detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div class="main ">
        ...
        <div class="news_detail">
            ...
            <div class="right">
                <!--ProgramDetail_250_250_1 AD1-->
                <gk:AD ID="AD1" runat="server" Width="250" Height="250" Category="ProgramDetail_250_250_1" />  
