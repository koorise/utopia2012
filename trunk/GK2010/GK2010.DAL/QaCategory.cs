...
namespace GK2010.DAL
{
	...
	public class QaCategory
	{
		...
		public bool Exists(int ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("UP_QaCategory_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(GK2010.Model.QaCategory model)
		{
			...
			DbHelperSQL.RunProcedure("UP_QaCategory_ADD",parameters,out rowsAffected);
		...
		public bool Update(GK2010.Model.QaCategory model)
		{
			...
			DbHelperSQL.RunProcedure("UP_QaCategory_Update",parameters,out rowsAffected);
		...
		public bool Delete(int ID)
		{
			...
			DbHelperSQL.RunProcedure("UP_QaCategory_Delete",parameters,out rowsAffected);
			return rowsAffected > 0;
		}
		#endregion
		...
		public DataSet GetModel(int ID)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("UP_QaCategory_GetModel",parameters,"ds");
			return ds;
		}
		#endregion	
        ...
        public DataSet GetList(string Keywords, string Type)
        {
            ...
            DataSet ds = DbHelperSQL.RunProcedure("UP_QaCategory_GetList_ByCondition", parameters, "ds");
            return ds;
        }
        #endregion 	
        ...
        public  bool CheckPermission(string Url)
        {
            ...
            int result = DbHelperSQL.RunProcedure("UP_QaCategory_CheckPermission", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
