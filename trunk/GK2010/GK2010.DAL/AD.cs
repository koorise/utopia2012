...
namespace GK2010.DAL
{
	...
	public class AD
	{
		...
		public bool Exists(int ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("UP_AD_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(GK2010.Model.AD model)
		{
			...
			DbHelperSQL.RunProcedure("UP_AD_ADD",parameters,out rowsAffected);
		...
		public bool Update(GK2010.Model.AD model)
		{
			...
			DbHelperSQL.RunProcedure("UP_AD_Update",parameters,out rowsAffected);
		...
		public bool Delete(int ID)
		{
			...
			DbHelperSQL.RunProcedure("UP_AD_Delete",parameters,out rowsAffected);
			return rowsAffected > 0;
		}
		#endregion
		...
		public DataSet GetModel(int ID)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("UP_AD_GetModel",parameters,"ds");
			return ds;
		}
		#endregion
		...
		public DataSet GetList(string Keywords, string Type)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_AD_GetList_ByCondition", parameters, "ds");
			return ds;
		}
		#endregion 
		...
		public DataSet GetList(int PageSize, int PageIndex, string Keywords, string Type, out int totalRows)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_AD_GetList", parameters, "ds");
