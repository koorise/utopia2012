...
{
	/// <summary>
	/// 业务逻辑类Library_Industry 的摘要说明。
	/// </summary>
	public class Library_Industry
	{
		#region  私有变量
		private readonly GK2010.DAL.Library_Industry dal=new GK2010.DAL.Library_Industry();
		#endregion
		...
		/// 得到一个对象实体
		/// </summary>
		public GK2010.Model.Library_Industry GetModel(int ID)
		{
			
			DataSet ds = dal.GetModel(ID);
			List<GK2010.Model.Library_Industry> models = DataTableToList(ds.Tables[0]);
			if (models.Count > 0)
			{
				return models[0];
			}
		...
		/// 得到一个对象实体(关键字)
		/// </summary>
		public GK2010.Model.Library_Industry GetModel(string Keywords)
		{
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public GK2010.Model.Library_Industry GetModelByCache(int ID)
		{
			
			string CacheKey = "Library_IndustryModel-" + ID;
			...
			return (GK2010.Model.Library_Industry)objModel;
		}
		#endregion
		...
		/// 列表(不分页)
		/// </summary>
		public List<GK2010.Model.Library_Industry> GetList(string Keywords, string Type)
		{
        ...
        /// 列表(不分页)
        /// </summary>
        public List<GK2010.Model.Library_Industry> GetList(TableName TableName, int TableID)
        {
		...
		/// 获得数据列表
		/// </summary>
		public List<GK2010.Model.Library_Industry> GetList(int PageSize, int PageIndex, string Keywords,string Type, out int totalRows)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Library_Industry> DataTableToList(DataTable dt)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Library_Industry> DataTableToList(DataRow[] drs)
		{
			List<GK2010.Model.Library_Industry> modelList = new List<GK2010.Model.Library_Industry>();
			GK2010.Model.Library_Industry model;
			foreach (DataRow dr in drs)
			{
				model = new GK2010.Model.Library_Industry();
				if(dr["ID"].ToString()!="")
				{
