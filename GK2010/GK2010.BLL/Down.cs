...
namespace GK2010.BLL
{
	...
	{
		#region  私有变量
		private readonly GK2010.DAL.Down dal=new GK2010.DAL.Down();
		#endregion
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(GK2010.Model.Down model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GK2010.Model.Down model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public GK2010.Model.Down GetModel(int ID)
		{
			
			DataSet ds = dal.GetModel(ID);
			List<GK2010.Model.Down> models = DataTableToList(ds.Tables[0]);
			if (models.Count > 0)
			{
				return models[0];
			}
		...
		/// 得到一个对象实体(关键字)
		/// </summary>
		public GK2010.Model.Down GetModel(string Keywords)
		{
		...
		public static string GetTitle(int ID)
		{
			...
			GK2010.Model.Down model = bll.GetModel(ID);
			if (model != null)
			{
				return model.Title;
			}
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public GK2010.Model.Down GetModelByCache(int ID)
		{
			
			string CacheKey = "DownModel-" + ID;
			...
			return (GK2010.Model.Down)objModel;
		}
		#endregion
		...
		/// 列表(不分页)
		/// </summary>
		public List<GK2010.Model.Down> GetList(string Keywords, string Type)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GK2010.Model.Down> GetList(int PageSize, int PageIndex, string Keywords,string Type, out int totalRows)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Down> DataTableToList(DataTable dt)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.Down> DataTableToList(DataRow[] drs)
		{
			List<GK2010.Model.Down> modelList = new List<GK2010.Model.Down>();
			GK2010.Model.Down model;
			foreach (DataRow dr in drs)
			{
				model = new GK2010.Model.Down();
				if(dr["ID"].ToString()!="")
				{
