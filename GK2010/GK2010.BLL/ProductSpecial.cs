...
{
	/// <summary>
	/// 业务逻辑类ProductSpecial 的摘要说明。
	/// </summary>
	public class ProductSpecial
	{
		#region  私有变量
		private readonly GK2010.DAL.ProductSpecial dal=new GK2010.DAL.ProductSpecial();
		#endregion
		...
		/// 得到一个对象实体
		/// </summary>
		public GK2010.Model.ProductSpecial GetModel(int ID)
		{
			
			DataSet ds = dal.GetModel(ID);
			List<GK2010.Model.ProductSpecial> models = DataTableToList(ds.Tables[0]);
			if (models.Count > 0)
			{
				return models[0];
			}
		...
		/// 得到一个对象实体(关键字)
		/// </summary>
		public GK2010.Model.ProductSpecial GetModel(string Keywords)
		{
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public GK2010.Model.ProductSpecial GetModelByCache(int ID)
		{
			
			string CacheKey = "ProductSpecialModel-" + ID;
			...
			return (GK2010.Model.ProductSpecial)objModel;
		}
		#endregion
		...
		/// 列表(不分页)
		/// </summary>
		public List<GK2010.Model.ProductSpecial> GetList(string Keywords, string Type)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<GK2010.Model.ProductSpecial> GetList(int PageSize, int PageIndex, string Keywords,string Type, out int totalRows)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.ProductSpecial> DataTableToList(DataTable dt)
		{
		...
		/// 转换数据列表
		/// </summary>
		public List<GK2010.Model.ProductSpecial> DataTableToList(DataRow[] drs)
		{
			List<GK2010.Model.ProductSpecial> modelList = new List<GK2010.Model.ProductSpecial>();
			GK2010.Model.ProductSpecial model;
			foreach (DataRow dr in drs)
			{
				model = new GK2010.Model.ProductSpecial();
				if(dr["ID"].ToString()!="")
				{
