...
namespace GK2010.DAL
{
	...
	public class Program
	{
		...
		public bool Exists(int ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("UP_Program_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(GK2010.Model.Program model)
		{
			...
			DbHelperSQL.RunProcedure("UP_Program_ADD",parameters,out rowsAffected);
		...
		public bool Update(GK2010.Model.Program model)
		{
			...
			DbHelperSQL.RunProcedure("UP_Program_Update",parameters,out rowsAffected);
		...
		public bool Delete(int ID)
		{
			...
			DbHelperSQL.RunProcedure("UP_Program_Delete",parameters,out rowsAffected);
			return rowsAffected > 0;
		}
		#endregion
		...
		public DataSet GetModel(int ID)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("UP_Program_GetModel",parameters,"ds");
			return ds;
		}
		#endregion
		...
		public DataSet GetList(string Keywords, string Type)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_Program_GetList_ByCondition", parameters, "ds");
			return ds;
		}
		#endregion 
		...
		public DataSet GetList(int PageSize, int PageIndex, string Keywords, string Type, out int totalRows)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_Program_GetList", parameters, "ds");
        ...
        #region 列表(后台分页管理)
        public DataSet GetList(int PageSize, int PageIndex, int ApplicationFlag, int FirstCategoryID,int SecondCategoryID,int OrderType, out int totalRows)
        {
            SqlParameter[] parameters = {
				new SqlParameter("@PageSize", SqlDbType.Int),
				new SqlParameter("@PageIndex", SqlDbType.Int),
				new SqlParameter("@ApplicationFlag", SqlDbType.Int),
				new SqlParameter("@FirstCategoryID", SqlDbType.Int),
                new SqlParameter("@SecondCategoryID", SqlDbType.Int),
                new SqlParameter("@OrderType", SqlDbType.Int)
			};
            parameters[0].Value = PageSize;
            parameters[1].Value = PageIndex;
            parameters[2].Value = ApplicationFlag;
            parameters[3].Value = FirstCategoryID;
            parameters[4].Value = SecondCategoryID;
            parameters[5].Value = OrderType;
            DataSet ds = DbHelperSQL.RunProcedure("UP_Program_GetList_UI", parameters, "ds");
            totalRows = int.Parse(ds.Tables[1].Rows[0]["Total"].ToString());
            return ds;
        }
        #endregion 
