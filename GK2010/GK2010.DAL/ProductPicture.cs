...
namespace GK2010.DAL
{
	...
	public class ProductPicture
	{
		...
		public bool Exists(int ID)
		{
			...
			int result= DbHelperSQL.RunProcedure("UP_ProductPicture_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public int Add(GK2010.Model.ProductPicture model)
		{
			...
			parameters[7].Value = model.DefaultFlag;
			parameters[8].Value = model.PictureSmall;
			parameters[9].Value = model.PictureBig;
			parameters[10].Value = model.PictureNormal;

			DbHelperSQL.RunProcedure("UP_ProductPicture_ADD",parameters,out rowsAffected);
		...
		public bool Update(GK2010.Model.ProductPicture model)
		{
			...
			DbHelperSQL.RunProcedure("UP_ProductPicture_Update",parameters,out rowsAffected);
		...
		public bool Delete(int ID)
		{
			...
			DbHelperSQL.RunProcedure("UP_ProductPicture_Delete",parameters,out rowsAffected);
			return rowsAffected > 0;
		}
		#endregion
		...
		public DataSet GetModel(int ID)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("UP_ProductPicture_GetModel",parameters,"ds");
			return ds;
		}
		#endregion
		...
		public DataSet GetList(string Keywords, string Type)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_ProductPicture_GetList_ByCondition", parameters, "ds");
			return ds;
		}
		#endregion 
		...
		public DataSet GetList(int PageSize, int PageIndex, string Keywords, string Type, out int totalRows)
		{
			...
			DataSet ds = DbHelperSQL.RunProcedure("UP_ProductPicture_GetList", parameters, "ds");
