<%@ Page Title="" Language="C#" MasterPageFile="~/ZPageBase_MainChannel.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="GK2010.Web.Down._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">  
    ...
    <div class="news_index">
        <!--DownIndex_960_100_1 AD1-->
        <gk:AD ID="AD1" runat="server" Width="960" Height="100" Category="DownIndex_960_100_1" />       
    </div>
    <div class="news_index">
        <div class="left">
            <div class=" mdB10"><gk:Slide ID="Slide1" runat="server" Width="344" Height="258" Category="DownIndex" /></div>
            <div class="news_content">
                <div class="hd"><h2><span><a href="/Down/0-1-1.html" >更多</a></span>下载排行</h2></div>
        ...
        <div class="center">
            <div class="news_content">
                <div class="hd"><h2><span><a href="/Down/0-2-1.html">更多</a></span>热门下载</h2></div>
    ...
    <div class="news_index  mdT10 mdB10">
        <!--DownIndex_960_100_2 AD2-->
        <gk:AD ID="AD2" runat="server" Width="960" Height="100" Category="DownIndex_960_100_2" />       
    </div>
    <gk:ChannelIndexCategory ID="ChannelIndexCategory1" runat="server" />
    <div class="clear"></div>
    <div class="news_index mdT10">
        <!--DownIndex_960_100_3 AD3-->
        <gk:AD ID="AD3" runat="server" Width="960" Height="100" Category="DownIndex_960_100_3" />       
    </div>   
</asp:Content>
