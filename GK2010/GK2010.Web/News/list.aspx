<%@ Page Title="" Language="C#" MasterPageFile="~/ZPageBase_MainChannel.master" AutoEventWireup="true"
    CodeBehind="list.aspx.cs" Inherits="GK2010.Web.News.list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <div class="news_list">
        ...
        <div class="right">
            <!--NewsList_250_250_1 AD1-->
            <gk:AD ID="AD1" runat="server" Width="250" Height="250" Category="NewsList_250_250_1" />  
            <gk:ProductCommend ID="ProductCommend1" runat="server" />
            <div class="clear"></div>
            <div class="news_content mdT10">
                <div class="hd">
                    <h2><span><a href="/News/0-3-1.html">更多</a></span>新闻推荐</h2>
                </div>
