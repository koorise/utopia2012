<%@ Page Title="" Language="C#" MasterPageFile="~/ZPageBase_MainChannel.master" AutoEventWireup="true"
    CodeBehind="detail.aspx.cs" Inherits="GK2010.Web.News.detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <div class="main ">
        ...
        <div class="news_detail">
            ...
            <div class="right">
                <!--NewsDetail_250_250_1 AD1-->
                <gk:AD ID="AD1" runat="server" Width="250" Height="250" Category="NewsDetail_250_250_1" />  
