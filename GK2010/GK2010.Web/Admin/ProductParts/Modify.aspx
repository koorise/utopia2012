<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="GK2010.Web.Admin.ProductParts.Modify" Title=""  ValidateRequest="false"   %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="nav" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
<h2 class="h1"><asp:Label ID="lblAttachFlag" runat="server" Text=""></asp:Label>编辑</h2>
...
<div class="tac mb10">
<asp:Button ID="btnBack" runat="server" Text="返 回" CssClass="btn_gray_big" CausesValidation="false" OnClick="btnBack_Click" ></asp:Button>
<asp:Button ID="btnAdd" runat="server" Text="提 交" CssClass="btn_yellow_big" OnClick="btnAdd_Click" ></asp:Button>
</div>
