<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.ProductCategory.Manage" Title="" %>
...
<h2 class="h1"><span  class="mr10">产品类别管理</span></h2>
        ...
        <ItemTemplate>        
         <tr class="vt tr1" onmouseover="showAdd('addbt_','<%#Eval("ID") %>')" onmouseout="hiddenAdd('addbt_','<%#Eval("ID") %>')">
		    <td class="td4 tdcur">			  
                ...
                <%#GK2010.Utility.StringHelper.GetStrAdd(Eval("ID"), Eval("Path"),2)%>
                <%#GK2010.Utility.StringHelper.GetStrAdd(Eval("ID"), Eval("Path"),2)%>
