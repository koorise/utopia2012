...
namespace GK2010.Web.Admin.MemberGroup
{
    public partial class Manage : System.Web.UI.Page
    {
	    ...
	    private void BindData()
	    {
		    ...
		    List<GK2010.Model.MemberGroup> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
            Pages1.PageSize = PageSize;
            Pages1.RecordCount = total;
	    ...
	    protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	    {
		    if (e.Row.RowType == DataControlRowType.DataRow)
		    {
                ...
                HyperLink HyperLinkPermmsion = (HyperLink)e.Row.FindControl("HyperLinkPermmsion");
                HyperLinkPermmsion.NavigateUrl = "Permission.aspx?ID="+model.ID;                
		    }
	    }
	    #endregion
