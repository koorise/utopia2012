...
namespace GK2010.Web.Admin.ConfigIndustry
{
    public partial class Add : System.Web.UI.Page
    {
	    protected void Page_Load(object sender, EventArgs e)
        {
            BLL.SystemTree.CheckPermission("ConfigIndustry");
			if (!IsPostBack)
			{
                txtParentID.Text = BLL.ConfigIndustry.GetTitle(ConfigParam.ParentID);
			}
		}
       	...
       	protected void btnAdd_Click(object sender, EventArgs e)
		{
            ...
            GK2010.Model.ConfigIndustry model = new GK2010.Model.ConfigIndustry();
