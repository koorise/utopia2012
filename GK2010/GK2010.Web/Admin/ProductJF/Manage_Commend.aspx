<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage_Commend.aspx.cs" Inherits="GK2010.Web.Admin.ProductJF.Manage_Commend" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">推荐积分商品列表</span></h2>
	...
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>
			...
			<asp:TemplateField HeaderText="排序">
			    <ItemTemplate>
				<asp:TextBox ID="txtSortID" runat="server" Text='<%# Eval("CommendSortID")%>' cssclass="input input_wa"></asp:TextBox>
				</ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 
