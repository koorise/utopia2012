<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.Help.Manage" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">帮助管理列表</span></h2>
	...
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>
			...
			<asp:TemplateField HeaderText="类别">
				<ItemTemplate><%# GK2010.BLL.HelpCategory.GetTitle( Eval("CategoryID")) %></ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 
			<asp:TemplateField HeaderText="参数">
				<ItemTemplate>
				<%# GK2010.Utility.StringHelper.GetStrFlag( Eval("IndexFlag"),"首") %>
				<%# GK2010.Utility.StringHelper.GetStrFlag( Eval("CommendFlag"),"荐") %>
				<%# GK2010.Utility.StringHelper.GetStrFlag( Eval("HotFlag"),"热") %>
				</ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField> 	
