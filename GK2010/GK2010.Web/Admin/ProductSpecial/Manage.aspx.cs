...
namespace GK2010.Web.Admin.ProductSpecial
{
	...
	private void BindData()
	{
		...
		List<GK2010.Model.ProductSpecial> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "", out total);
	...
	protected void grid_RowDataBound(object sender, GridViewRowEventArgs e)
	{
		...
		{
			GK2010.Model.ProductSpecial model = (GK2010.Model.ProductSpecial)e.Row.DataItem;
