...
{
    public partial class ManageVIP : System.Web.UI.Page
    {
       
	    #region PageLoad
	    protected void Page_Load(object sender, EventArgs e)
	    {
            BLL.SystemTree.CheckPermission("MemberVIP");
		    if (!IsPostBack)
		    {
			    BindData();
		    }
	    ...
	    private void BindData()
	    {
		    ...
		    List<GK2010.Model.Member> models = bll.GetList(PageSize, PageIndex, ConfigParam.Keyword, "MemberVIP", out total);
	    ...
	    {
            string UrlRedirect = "managevip.aspx?Keyword={0}";
