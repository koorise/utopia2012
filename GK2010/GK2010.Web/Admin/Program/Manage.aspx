<%@ Page Language="C#" MasterPageFile="~/ZSiteBaseAdmin.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="GK2010.Web.Admin.Program.Manage" Title="" %>
...
<h2 class="h1"><span class="mr10 fl">方案中心管理</span></h2>
<div id="divGrid" class="admin_table mb10" >
	<asp:GridView ID="grid" runat="server" OnRowDataBound="grid_RowDataBound" Width="100%" BorderWidth="0" AutoGenerateColumns="false" GridLines="None" >
		<Columns>
			...
			<asp:TemplateField HeaderText="应用行业" >
				<ItemTemplate>
				    <asp:Literal ID="txtIndustry" runat="server"></asp:Literal>
				</ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField>
			<asp:TemplateField HeaderText="适用介质" >
				<ItemTemplate>
                    <asp:Literal ID="txtMedium" runat="server"></asp:Literal>
				</ItemTemplate>
				<ItemStyle cssclass="td2" />
			</asp:TemplateField>
