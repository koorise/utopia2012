...
using GK2010.Common;
namespace GK2010.Web.Admin.SlideCategory
{
    public partial class Manage : System.Web.UI.Page
    {
        ...
        {
            BLL.SystemTree.CheckPermission("SlideCategory");
			if (!IsPostBack)
			{
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            foreach (RepeaterItem item in RepeaterList.Items)
            {
                ...
                GK2010.BLL.SlideCategory bll = new GK2010.BLL.SlideCategory();
                GK2010.Model.SlideCategory model = bll.GetModel(int.Parse(txtID.Value));
                if (model != null)
                {
