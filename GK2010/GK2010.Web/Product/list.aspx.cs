    ...
    public partial class list : PageBase
    {
        ...
        private void BindProduct()
        {
            ...
            AspNetPager1.UrlRewritePattern = string.Format(ConfigUrl.UrlProductCategory, ConfigParam.BigID, ConfigParam.SmallID, 0,
                ...
                ConfigParam.OrderType,ConfigParam.ShowType,
                "{0}");
        ...
        protected void RepeaterListProduct_ItemDataBound(object sender, System.Web.UI.WebControls.RepeaterItemEventArgs e)
        {
            switch (e.Item.ItemType)
            {
                ...
                case ListItemType.EditItem:
                    ...
                    Literal txtImg = (Literal)e.Item.FindControl("txtImg");
                    txtImg.Text = "<a href='" + Url + "' target='_blank' title='" + Title + "'><img class='pic100' src='" + Picture + "' /></a>";

                    Literal txtTitle = (Literal)e.Item.FindControl("txtTitle");
                    txtTitle.Text = "<a href='" + Url + "'  target='_blank'  title='" + Title + "'>" + Title + "</a>";

                    Literal txtPriceOld = (Literal)e.Item.FindControl("txtPriceOld");
                    txtPriceOld.Text = model.DefaultPriceOld.ToString("市场价：￥0.00");

                    Literal txtPrice = (Literal)e.Item.FindControl("txtPrice");
                    txtPrice.Text = model.DefaultPrice.ToString("会员价：￥0.00");
